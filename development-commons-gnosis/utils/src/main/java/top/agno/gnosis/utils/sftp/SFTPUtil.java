package top.agno.gnosis.utils.sftp;
...
public class SFTPUtil {
    ...
    public static <T> void genExcelOutStream(HttpServletResponse response, byte[] bfile, String fileName) {
        ...
        try {
            ...
            byte[] buff = new byte[bfile.length + 1024];
